			...
			var flag=false;
  				...
  				for(i=1;i<len;i++)
  				{
  					...
  					if(document.getElementById("chk"+i).checked)
  					{
  						...
  						{
  	  						flag=true;
  	  						RID=RID+document.getElementById("trip"+i).value+",";
  						}  						
  					}
  				...
  				else
  				{
  					...
  					document.kmlreports.action="activedeactiveKML.jsp?RID="+RID;
			...
			var flag=false;
  				...
  				else
  				{
  	  			...
  	  			document.getElementById("btnchk").value="Active";
  					document.kmlreports.action="activedeactiveKML.jsp?btn=Active&RID="+RID;
...
<tr><td>
<form name="kmlreports" method="post" action="" onsubmit="return validate();">
<%!
Connection conn;
%>
<% 
