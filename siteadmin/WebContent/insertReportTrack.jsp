...
try{
	...
	String sql="select PageName from db_gps.t_reportnumber where PageName='"+pageName+"'";
	...
	{
	String sqlInsert="INSERT INTO db_gps.t_reportnumber (ReportName,PageName,ActiveStatus,EnteredBy) VALUES "+
...
if(Msg.equals("1"))
{
	 response.sendRedirect("ReportTrack.jsp?Msg="+Msg);
}
else
{
