...
try{
	...
	c= DriverManager.getConnection("jdbc:mysql://173.234.153.82/db_avlalldata","fleetview","1@flv");
...
<input type="radio" name="limit" value="All" > All
	...
	//	String sqlUnitTyp = "select * from db_gps.t_unitmaster where unitid='"+unitid+"'";
		...
		sqlProcessed="SELECT Body,status,storedtime FROM t_peopletracker"+thedate2+" where Unitid='"+imei+"'   order by storedtime desc "+limit;
