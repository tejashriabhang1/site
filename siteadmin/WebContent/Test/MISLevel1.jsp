...
//	thedate3=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(thedate2));
	...
	<form name="unitform" action="" method="get" >
		...
		<td class="hed" align="center" style="width: 40px;">Code Version </td>
		...
		while(rs.next())
		{
			...
			String codeVersion="";
			String sql_forCodeVersion = "select * from db_gps.t_ftplastdump where unitid='"+unitid+"' ";
			ResultSet rst = st2.executeQuery(sql_forCodeVersion);
			if(rst.next())
			{
				codeVersion = rst.getString("CodeVersion");
			}
			else
			{
				codeVersion="-";
			...
			<td class="bodyText" align="right" ><div align="right"><%=codeVersion%></div></td>
