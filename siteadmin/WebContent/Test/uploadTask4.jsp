...
try{	   
			        ...
			        for (int i = 1; i < sheetData.size(); i++) {
			         ...
			         //   insertToDb(rw);
			            //inset row into database
							...
							String frmDate="",toDate="",user="",project="",task="",assignTo="",status="",comletionDate="",comments="-";
							int p=0;
							int countFeild=0;
						try
						{
						...
						{	
							...
							//	System.out.println(stringTokenizer.nextToken());
								...
								frmDate = stringTokenizer.nextToken().trim();
								...
								comletionDate = stringTokenizer.nextToken();
						...
						comments = comments.trim();
							...
							System.out.println("The task before is :"+task);
							...
							System.out.println("The comments is :**"+comments);
							...
							if(status.equals("Done") || status.equalsIgnoreCase("Done")) {
								task_percent_complete="100";
							}else{
								task_percent_complete="0";
							}
							
							if(countFeild==8 || countFeild==9){
							//insert into table
							String sql ="insert into dotproject.tasks(task_id,task_name,task_parent,task_project,task_owner,task_start_date,task_end_date,task_description,task_creator,task_percent_complete,task_completion_date_time)values('"+newtaskid+"','"+task+"','"+newtaskid+"','"+project+"','"+userid+"','"+frmDate+"','"+toDate+"','"+task+"','"+userid+"','"+task_percent_complete+"','"+comletionDate+"')";	
							...
							int l =st2.executeUpdate(sql1);
							System.out.println("The number of rows updated :"+l);
							}//endif	
						}catch (Exception e) {
        ...
        //=======================================================================   
        response.sendRedirect("uploadTask3.jsp?msg=1");
}catch(Exception e){
