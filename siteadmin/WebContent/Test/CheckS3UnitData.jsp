...
// 				sqlProcessed="SELECT StoredTime,VehRegNo,Vehid,Transporter,Body,UnProcessedStamps,MailFrom FROM t_ip"+thedate2+"  where Unitid='"+unitid+"'    order by storedtime desc "+limit;	
// 		}
// 		else
// 		{
...
// 		}
			...
			//sqlProcessed="SELECT StoredTime,VehRegNo,Vehid,Transporter,Body,UnProcessedStamps,MailFrom FROM db_avlalldata.t_ip"+thedate2+"  where Unitid='"+unitid+"'    order by storedtime desc "+limit;
			sqlProcessed="SELECT * FROM db_avlalldata.t_ip"+thedate2+"  where Unitid='"+unitid+"'   UNION select * from  db_avlalldata.t_ip"+thedate2+"Processed where Unitid='"+unitid+"'  order by storedtime desc "+limit;
