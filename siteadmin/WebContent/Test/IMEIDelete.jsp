...
System.out.println(MM_dbConn_STRING1);
System.out.println(MM_dbConn_STRING6);
...
{	
	 String SqlUpdate="UPDATE db_gps.t_imeidetails  SET Status ='Deactive' WHERE unitid='"+id+"' and sr='"+sr+"' limit 1 ";
	System.out.println(">>>>>>>>SqlDeleteMaster:"+SqlUpdate);
	i=stmt1.executeUpdate(SqlUpdate);
	System.out.println("i===>"+i);
	String SqlUpdate1="UPDATE db_gps.t_imeidetailsHistory SET Status ='No' WHERE unitid='"+id+"' and sr='"+sr+"' limit 1 ";
	j=stmt2.executeUpdate(SqlUpdate1);
