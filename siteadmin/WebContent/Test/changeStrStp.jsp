...
<form name="strstpform" action="strstpSend.jsp" method="post"">
<table border="0" align="center" width="100%">
<tr><td bgcolor="#f5f5f5"" align="center">
<font color="black" size="2">
<b>
Enter the Unit ID, Start Limit and Stop limit for the vehicle.
</b>
<br><br>
</font>
</td></tr>
...
<tr>
<td bgcolor="#f5f5f5"><font size="2">Start Limit :</font></td>
<td bgcolor="#f5f5f5">
<input type="text" name="strt" id="strt" size="15" value="">
<br>
</td>
</tr>
<tr>
<td bgcolor="#f5f5f5"><font size="2">Stop Limit :</font></td>
<td bgcolor="#f5f5f5">
<input type="text" name="stp" id="stp" size="15" value="">
<br>
</td>
</tr>
