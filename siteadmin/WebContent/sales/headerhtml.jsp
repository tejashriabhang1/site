...
<table width="100%" height="488" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="18%" height="488" valign="top"> 
      <table width="212" border="0" cellspacing="1" cellpadding="2">
        <tr> 
        ...
        <tr> 
          <td height="171" valign="top" bgcolor="#f5f5f5"><div align="center">
              ...
              <font size="2" face="Verdana">
               ...
               <%!
					Statement stlink;
					String sqllink;			 Connection conn11;		              
              %>

              <%
             
          	Class.forName(MM_dbConn_DRIVER);
          	conn11 = DriverManager.getConnection(MM_dbConn_STRING,MM_dbConn_USERNAME,MM_dbConn_PASSWORD);
					try{
							stlink=conn11.createStatement();
							sqllink="select * from t_links where UserRole='"+session.getAttribute("role").toString()+"' and AccessStatus='Yes' and OnPage='mainpage' and ModuleName='Sales'";			
        ...
        <table border="0" cellpadding="2" width="100%" cellspacing="1">
          <tr>
                <td bgcolor="#2696B8" height="22">
                  <p align="center"><b><font face="Verdana" size="2" color="#FFFFFF">Sales Admin Module</font></b></td>
          </tr>
          <tr>
                <td height="11">
                  <div align="center">
