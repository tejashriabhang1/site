...
<input type="radio" name="limit" value="All" > ALL
	...
	<!-- 	<td class="hed" align="center">Vehicle No</td>
		...
		/* 	sql="SELECT * FROM smartgridrawdata.t_sgimages"+thedate2+"  where Unitid='"+unitid+"'  UNION select * from smartgridrawdata.t_sgimages"+thedate2+"Processed where Unitid='"+unitid+"'  UNION select * from smartgridrawdata.t_sgimages"+thedate2+"_bulk where Unitid='"+unitid+"' order by storedtime desc "+limit; */
			sql="SELECT * FROM smartgrid.t_sgimages"+thedate2+"  where Unitid='"+unitid+"' UNION select * from smartgrid.t_sgimages"+thedate2+"_bulk where Unitid='"+unitid+"' order by storedtime desc "+limit;
