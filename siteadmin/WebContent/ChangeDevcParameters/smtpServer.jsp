...
<form name="smtpform" action="smtpSend.jsp" method="post"">
<table border="0" align="center" width="100%">
<tr><td bgcolor="#f5f5f5"" align="center">
<font color="black" size="2">
<b>
Enter the Unit ID and SMTP Server Name for the vehicle.
</b>
<br><br>
</font>
</td></tr>
...
<tr>
<td bgcolor="#f5f5f5"><font size="2">SMTP Server Name :</font></td>
<td bgcolor="#f5f5f5">
<input type="text" name="smtp" id="smtp" size="15" value="">
<br><br>
</td>
</tr>
<tr>
