...
String unit_type=request.getParameter("u_type");
String mob="";
String uname=session.getAttribute("username").toString();
String msg_type="Change Unit Type Msg";
...
<%
	...
	try{
		...
		sms="UI"+u_id+"#SET0002:0000,-,-,#"+unit_type+",-,-";
        ...
        //  out.println("Unit ID="+u_id+", Mob No.="+mob+",Actual Msg="+sms+",Msg Type="+msg_type+",Sender ID="+uname+",Date_Time="+now1);
         String newmsg="insert into db_gps.t_serveralerts "+ 
  		...
  		"  '"+u_id+"','"+sms+"','"+mob+"','No','SiteAdmin-ChangeUnit','"+msg_type+"','"+uname+"','"+vehreg+"','"+OwnerName+"' )";
      ...
      //  out.println("Unit ID="+u_id+", Mob No.="+mob+",Actual Msg="+sms+",Msg Type="+msg_type+",Sender ID="+uname+",Date_Time="+now1);
        ...
        %>
        <jsp:forward page="changeUnit.jsp">
