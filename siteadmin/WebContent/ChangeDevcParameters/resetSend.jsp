...
//         out.println("---URL---"+url);
		...
		"(UnitID,Message,MobNo,SentStatus,EntryBy,MsgType,SenderID,VehicleRegNo,Transporter,SMSStatus) values ("+
		"  '"+u_id+"','"+sms+"','"+mob+"','No','SiteAdmin-Reset','"+msg_type+"','"+uname+"','"+vehreg+"','"+OwnerName+"','SMS' )";
