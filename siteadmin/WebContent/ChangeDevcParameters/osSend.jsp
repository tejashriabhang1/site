<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    import="java.sql.ResultSet" import="java.sql.Statement" import="java.text.Format" import="java.text.SimpleDateFormat" import="java.net.HttpURLConnection" 
    %>
...
<%
	...
	//	mob="9561031265";
        ...
        try
        {
            ...
            ResultSet  rsnd=stmt2.executeQuery(sqlsms);
        ...
        catch(Exception e)
        {
          ...
          // 	sms=URLEncoder.encode(sms);
           //	smsurl=smsurl.replaceAll("\\+", "");
           	smsurl=smsurl.replaceAll("numbers",mob);
           	smsurl=smsurl.replaceAll("sms",sms);
          // 	smsurl=smsurl.replaceAll("\"","");
           //	smsurl=smsurl.replaceAll(" ","+");
           //	smsurl=smsurl.replace("%23","#"); 
		//	smsurl=smsurl.replace("%3A",":"); 
		//	smsurl=smsurl.replace("%2C"," "); 
