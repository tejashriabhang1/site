...
<%
	String sms="";
	try{
		// UI(old unit id)#SET0001:0000,(new unit id)@
		sms="UI"+u_id+"#SET0001:0000,"+new_id+"@";
        ...
        //  out.println("Unit ID="+u_id+", Mob No.="+mob+",Actual Msg="+sms+",Msg Type="+msg_type+",Sender ID="+uname+",Date_Time="+now1);
         String newmsg="insert into db_gps.t_serveralerts "+ 
  		...
  		"  '"+u_id+"','"+sms+"','"+mob+"','No','SiteAdmin-UnitIdAvlLite','"+msg_type+"','"+uname+"','"+vehreg+"','"+OwnerName+"' )";
  ...
  }catch(Exception e2)
  {
      ...
      //  out.println("Unit ID="+u_id+", Mob No.="+mob+",Actual Msg="+sms+",Msg Type="+msg_type+",Sender ID="+uname+",Date_Time="+now1);
        ...
        %>
        <jsp:forward page="changeUnitId.jsp">
