...
String msg_type="Transmission and Stamping Interval Msg";
...
<%
	...
	try{
		...
		sms="UI"+u_id+"#SET0003:0000,"+trans+",-,"+stamp+",-,-";
       ...
       // }
        ...
        //  out.println("Unit ID="+u_id+", Mob No.="+mob+",Actual Msg="+sms+",Msg Type="+msg_type+",Sender ID="+uname+",Date_Time="+now1);
         String newmsg="insert into db_gps.t_serveralerts "+ 
  		...
  		"  '"+u_id+"','"+sms+"','"+mob+"','No','SiteAdmin-TxmnStmp','"+msg_type+"','"+uname+"','"+vehreg+"','"+OwnerName+"' )";
  ...
  }catch(Exception e2)
  {
      ...
      //  out.println("Unit ID="+u_id+", Mob No.="+mob+",Actual Msg="+sms+",Msg Type="+msg_type+",Sender ID="+uname+",Date_Time="+now1);
        ...
        %>
        <jsp:forward page="trans_stamp.jsp">
