...
String new_id=request.getParameter("trans");
String mob="";
String uname=session.getAttribute("username").toString();
String msg_type="Message send to device";
...
<%
	...
	try{
		...
		/* sms="UI"+u_id+"#SET0003:0000,"+new_id+",-,-,-,-";
 ...
 */		/* System.out.println(">>>Afeter ConVersion>Replacement>>>>sms>>>"+sms);
        ...
        String msg=sms;
        String mobnomob=mob;
        System.out.println("MobileNo "+mob+" MailString " +sms+ " sms send");
        String msgid = null; String smsurl = "";
        try
        {
          sms = msg.trim();
      ...
      //  out.println("Unit ID="+u_id+", Mob No.="+mob+",Actual Msg="+sms+",Msg Type="+msg_type+",Sender ID="+uname+",Date_Time="+now1);
        ...
        %>
         <jsp:forward page="sendMsgUnit.jsp">
