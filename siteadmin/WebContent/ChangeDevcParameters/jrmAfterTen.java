	    	...
	    	while(rs.next())
	    	{
	    		...
	    		*/
	    		...
	    		try{
		            ...
		            String smsurl="http://india.timessms.com/http-api/receiverall.asp?username=Transworld&password=vikram&sender=transwld&sign=FleetView&to=9595889312&message="+sms+"&gateway=regular";
