...
<form name="ipform" action="ipSend.jsp" method="post"">
<table border="0" align="center" width="100%">
<tr><td bgcolor="#f5f5f5"" align="center">
<font color="black" size="2">
<b>
Enter the Unit ID, IP Server, IP Port.
</b>
<br><br>
</font>
</td></tr>
...
<tr>
<td bgcolor="#f5f5f5"><font size="2">IP Server :</font></td>
<td bgcolor="#f5f5f5">
<input type="text" name="server" id="server" size="15" value="">
<br><br>
</td>
</tr>
<tr>
<td bgcolor="#f5f5f5"><font size="2">IP Port :</font></td>
<td bgcolor="#f5f5f5">
<input type="text" name="port" id="port" size="15" value="">
<br><br>
</td>
</tr>
