...
%>
<form name="chuidform" action="chunitidSend.jsp" method="post"">
<table border="0" align="center" width="100%">
<tr><td bgcolor="#f5f5f5"" align="center">
<font color="black" size="2">
<b>
Enter the Unit ID which is to be changed and its new value.
</b>
<br><br>
</font>
</td></tr>
...
<td bgcolor="#f5f5f5"><font size="2">New Unit ID :</font></td>
<td bgcolor="#f5f5f5">
<input type="text" name="chg_uid" id="chg_uid" size="15" value="">
<br><br>
</td>
</tr>
<tr>
