              ...
              Class.forName(MM_dbConn_DRIVER);
              	conn12 = DriverManager.getConnection(MM_dbConn_STRING,MM_dbConn_USERNAME,MM_dbConn_PASSWORD);
					try{
							...
							//sqllink="select * from t_links where UserName='"+session.getAttribute("username").toString()+"' and UserRole='"+session.getAttribute("role").toString()+"' and AccessStatus='Yes' and OnPage='mainpage' and ModuleName='FleetView'";	

							sqllink="select * from t_links where UserRole='"+session.getAttribute("role").toString()+"' and AccessStatus='Yes' and OnPage='mainpage' and ModuleName='ChangeDevcParam'";
        ...
        <table border="0" cellpadding="2" width="100%" cellspacing="1">
          <tr>
                <td bgcolor="#2696B8" height="22">
                  <p align="center"><b><font face="Verdana" size="2" color="#FFFFFF">FleetView Admin Module</font></b></td>
          </tr>
          <tr>
                <td height="11">
                  <div align="center">
