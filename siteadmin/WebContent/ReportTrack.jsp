...
try{
	...
	%>
	<form name="reportTrack" action="insertReportTrack.jsp" method="post" onsubmit="return validate();">
	<table border="0" width="100%" align="center"> 
	<div align="right"><font size="2"><a href="ReportTrackDetails.jsp">Show Report Names</a></font></div>
	<tr>
