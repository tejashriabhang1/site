...
//	String user="";
	...
	rfname=session.getAttribute("username").toString(); //.setAttribute("rfname",fnamelist);
...
<%
	...
	/*	if(stdate.length()>12)
		{
			 sql="SELECT * FROM t_veh"+vehcode+"  where concat(TheFieldDataDate,' ',TheFieldDataTime) >='"+stdate+" "+sttime+"' and concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+enddate+" "+endtime+"' and TheFiledTextFileName ='OS' order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc";
			
		}
		else
		{
			 sql="SELECT * FROM t_veh"+vehcode+"  where TheFieldDataDate >='"+stdate+" "+sttime+"' and concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+enddate+" "+endtime+"' and TheFiledTextFileName ='OS' order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc";
			
		}
		ResultSet rstoscount=stmt1.executeQuery(sql);
		...
		if(stdate.length()>12)
		{
			 sql="SELECT * FROM t_veh"+vehcode+"  where concat(TheFieldDataDate,' ',TheFieldDataTime) >='"+stdate+" "+sttime+"' and concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+enddate+" "+endtime+"' and TheFiledTextFileName ='AC' and Distance >5 order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc";
					}
		else
		{
			 sql="SELECT * FROM t_veh"+vehcode+"  where TheFieldDataDate >='"+stdate+" "+sttime+"' and concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+enddate+" "+endtime+"' and TheFiledTextFileName ='AC' and Distance >5 order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc";
			
		}
		
		ResultSet rstaccount=stmt1.executeQuery(sql);
		...
		if(stdate.length()>12)
		{
			 sql="SELECT * FROM t_veh"+vehcode+"  where concat(TheFieldDataDate,' ',TheFieldDataTime) >='"+stdate+" "+sttime+"' and concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+enddate+" "+endtime+"' and TheFiledTextFileName ='DC' and Distance >120 order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc";
			
		}
		else
		{
			 sql="SELECT * FROM t_veh"+vehcode+"  where TheFieldDataDate >='"+stdate+" "+sttime+"' and concat(TheFieldDataDate,' ',TheFieldDataTime) <='"+enddate+" "+endtime+"' and TheFiledTextFileName ='DC' and Distance >120 order by concat(TheFieldDataDate,' ',TheFieldDataTime) desc";
			
		}
		
		ResultSet rstdccount=stmt1.executeQuery(sql);;
		while(rstdccount.next())
		{
		dccount++;
		}*/
	//	System.out.print(oscount+" "+account+" "+dccount);
