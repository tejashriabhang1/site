...
try{
	...
	String sql="select PageName from db_leaveapplication.t_reportnumber where PageName='"+pageName+"'";
	...
	{
	String sqlInsert="INSERT INTO db_leaveapplication.t_reportnumber (ReportName,PageName,ActiveStatus,EnteredBy) VALUES "+
...
if(Msg.equals("1"))
{
	 response.sendRedirect("TWReportReg.jsp?Msg="+Msg);
}
else
{
  response.sendRedirect("TWReportDetail.jsp?Error="+Error);
}
%>
