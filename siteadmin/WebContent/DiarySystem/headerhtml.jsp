        ...
        <tr> 
          <td height="171" valign="top" bgcolor="#f5f5f5"><div align="center">
              ...
              <font size="2" face="Verdana">
               ...
               <%!
					Statement stlink;
					String sqllink;		 Connection conn;			              
              %>
              <%
              ...
              try{
							stlink=conn.createStatement();
							sqllink="select * from t_links where  UserRole='"+session.getAttribute("role").toString()+"' and AccessStatus='Yes' and OnPage='mainpage' and ModuleName='DiarySystem'";
