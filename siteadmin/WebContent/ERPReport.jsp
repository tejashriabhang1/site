...
try{
	...
	%>
	<form name="reportTrack" action="InsertERPReport.jsp" method="get" onsubmit="return validate();">
	<table border="0" width="100%" align="center"> 
	<div align="right"><font size="2"><a href="ERPReportDetail.jsp">Show Report Names</a></font></div>
	<tr>
