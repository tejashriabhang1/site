              ...
              <%
					try{
						...
						stlink=conn12.createStatement();
							sqllink="select * from t_links where  UserRole='"+session.getAttribute("role").toString()+"' and AccessStatus='Yes' and OnPage='mainpage' and ModuleName='MISReports'";			
        ...
        <table border="0" cellpadding="2" width="100%" cellspacing="1">
          <tr>
                <td bgcolor="#2696B8" height="22">
                  <p align="center"><b><font face="Verdana" size="2" color="#FFFFFF">MIS Reports  Admin Module</font></b></td>
          </tr>
          <tr>
                <td height="11">
                  <div align="center">
