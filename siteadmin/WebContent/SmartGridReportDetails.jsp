...
%>
	...
	<tr><td colspan="10" align="center" class="sorttable_nosort"><b>Check Report Numbers In SmartGrid</b> 
	</td></tr>
 ...
 &nbsp;&nbsp;
	...
	<div align="right"><font size="2"><a href="SmartGridReport.jsp">Add Report</a></font></div>
	</td>
	</tr>
	...
	%>
		...
		{
			sql="SELECT * from smartgrid.t_reportnumber" ;
